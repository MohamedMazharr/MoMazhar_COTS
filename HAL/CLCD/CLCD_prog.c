...
void CLCD_voidSendNumber(sint32 Copy_s32Number)
{
	...
	sint8 Local_s8Counter2; //because if it was unsigned the condition Local_s8Counter2 >= 0 will always be true
    ...
    // in the previous line uint32 for the misra rules and uint8 because i want the RightDigit only
